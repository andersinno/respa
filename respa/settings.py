...
env = environ.Env(
    ...
    RESPA_EXCHANGE_ENABLED=(bool, True),
    RESPA_EXCHANGE_AUTH_CLIENT_ID=(str, ""),
    RESPA_EXCHANGE_AUTH_CLIENT_SECRET=(str, ""),
    RESPA_EXCHANGE_AUTH_TENANT_ID=(str, ""),
    RESPA_PAYMENTS_ENABLED=(bool, False),
    RESPA_PAYMENTS_PROVIDER_CLASS=(str, ""),
    RESPA_PAYMENTS_PAYMENT_WAITING_TIME=(int, 15),
    RESPA_SAP_INTERFACE_ID=(str, ""),
    RESPA_SAP_INTERFACE_NAME=(str, ""),
    RESPA_INVOICES_SFTP_SERVER_IP=(str, ""),
    RESPA_INVOICES_SFTP_USERNAME=(str, ""),
    RESPA_INVOICES_SFTP_RSA_KEY_PATH=(str, ""),
    RESPA_INVOICES_SFTP_RSA_KEY_PASSWORD=(str, ""),
...
USE_GCLOUD = env.str("STABLE_GCS_BUCKET_NAME") and env.str(
    "STABLE_GCS_BUCKET_CREDENTIALS"
)
if USE_GCLOUD:
...
RESPA_ADMIN_USERNAME_LOGIN = env.bool("RESPA_ADMIN_USERNAME_LOGIN", default=True)

RESPA_EXCHANGE_ENABLED = env("RESPA_EXCHANGE_ENABLED")
RESPA_EXCHANGE_AUTH_CLIENT_ID = env("RESPA_EXCHANGE_AUTH_CLIENT_ID")
RESPA_EXCHANGE_AUTH_CLIENT_SECRET = env("RESPA_EXCHANGE_AUTH_CLIENT_SECRET")
RESPA_EXCHANGE_AUTH_TENANT_ID = env("RESPA_EXCHANGE_AUTH_TENANT_ID")
...
RESPA_SAP_INTERFACE_NAME = env("RESPA_SAP_INTERFACE_NAME", default="VARAAMO")

RESPA_INVOICES_SFTP_SERVER_IP = env("RESPA_INVOICES_SFTP_SERVER_IP")
RESPA_INVOICES_SFTP_RSA_KEY_PATH = env("RESPA_INVOICES_SFTP_RSA_KEY_PATH")
RESPA_INVOICES_SFTP_RSA_KEY_PASSWORD = env("RESPA_INVOICES_SFTP_RSA_KEY_PASSWORD")
RESPA_INVOICES_SFTP_USERNAME = env("RESPA_INVOICES_SFTP_USERNAME")
