...
class SaveResourceView(ExtraContextMixin, PeriodMixin, CreateView):
    ...
    def _save_or_update_opening_hours_via_period_templates(self):
        """
        Creates the period instance from the selected period template
        if it doesn't already exists and assigns 'template_src' to the
        period template from which it was copied/created.
        ...
        # Make a copy from period template and assign it to this resource if it doesn't
        # already exists.
