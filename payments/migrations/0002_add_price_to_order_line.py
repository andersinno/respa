...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='total_price',
            field=models.DecimalField(decimal_places=2, default=0.0, max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))], verbose_name='Total price including VAT'),
